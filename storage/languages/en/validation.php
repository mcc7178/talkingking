...
return [
    ...
    */
    ...
    'success' => 'succeed',
    'fail' => 'failed',
    'password_num_letter' => 'digit&letter included',
    'password_error' => 'password error',
    'code_key_error' => 'code key error',
    'security_code_error' => 'security code error',
    'code_key_expired' => 'Verification code has not been sent or expired, please resend',
    'account_not_exist' => 'user account not exist',
    'account_exist' => 'user account already exist',
    'account_null' => 'The account has been deactivated,please contact administrator',
    'invate_code_not_exist' => 'invate code not exist',
    'type_error' => 'request type error',
    'amount_gt' => 'amount must great than 10000',
    'amount_multi' => '10000 integer multiples',
    'security_code_empty' => 'Trading Password not set ',
    'product_disable' => 'not available now',
    'product_full' => 'full Already',
    'product_balance' => 'remaining amount :amount',
    'balance_amount'=>'available assets :amount',
    'redeem_balance_not_enought' => 'insufficient redeemable amount',
    'password_same' => 'repassword must same as password',
    'security_len' => '6 bits required',
    'security_code_repeat' => 'non-repeating digit',
    'security_code_continuous' => 'must be 6 non-consecutive numbers',
    'recharge_forbidden' => 'user account has been forbidden to withdraw, please contact administrator',
    'coin_withdraw_forbidden' => 'current coin bas been forbidden to withdraw',
    'withdraw_min' => 'current coin minimum withdrawal amount is  :amount',
    'withdraw_max' => 'current coin maximum withdrawal amount is  :amount',
    'withdraw_24_hours' => 'the remaining 24-hour withdrawal limit of the current currency is :amount',
];
