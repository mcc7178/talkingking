...
return [
    ...
    */
    ...
    'success' => '请求成功',
    'fail' => '请求失败',
    'password_num_letter' => '密码至少包含一个数字和一个字母',
    'password_error' => '密码错误',
    'code_key_error' => '验证码错误',
    'security_code_error' => '安全密码错误',
    'code_key_expired' => '尚未发送验证码或验证码已过期,请重新发送',
    'account_not_exist' => '用户账户不存在',
    'account_exist' => '用户账户已存在',
    'account_null' => '该账户已经被停用，请联系管理员',
    'invate_code_not_exist' => '邀请码不存在',
    'type_error' => '请求参数错误',
    'amount_gt' => '金额必须大于10000',
    'amount_multi' => '限额10000的整数倍',
    'security_code_empty' => '您尚未设置安全密码',
    'product_disable' => '该产品尚未开放购买',
    'product_full' => '该产品已满额',
    'product_balance' => '当前产品剩余额度为 :amount',
    'balance_amount' => '您当前可用余额为 :amount',
    'redeem_balance_not_enought' => '可赎回额度不足',
    'password_same' => '密码和重复密码不一致',
    'security_code_len' => '交易密码必须是6位数字',
    'security_code_repeat' => '交易密码必须是不重复的数字',
    'security_code_continuous' => '交易密码必须是6位不连续的数字',

    'withdraw_forbidden' => '当前用户已被禁止提现,请联系管理员处理',
    'coin_withdraw_forbidden' => '当前币种禁止提现',
    'withdraw_min' => '当前币种单笔最小提现额度为 :amount',
    'withdraw_max' => '当前币种单笔最大提现额度为 :amount',
    'withdraw_24_hours' => '当前币种24小时剩余提现额度为 :amount',
];
